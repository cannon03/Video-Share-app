package com.projects.cannon.VideoShare.model;
...
public class User {
    ...
    private Set<String> uploadedVideos=ConcurrentHashMap.newKeySet();

    public void addToUploadedVideos(String videoId){
        uploadedVideos.add(videoId);
    }
    public void removeFromUploadedVideos(String videoId){
